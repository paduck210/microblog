...
followers = db.Table(
    'followers',
    db.Column('follower_id', db.Integer, db.ForeignKey('user.id')), # fan
    db.Column('followed_id', db.Integer, db.ForeignKey('user.id'))  # BTS
)
...
class User(UserMixin, db.Model):
    ...
    def check_password(self, password):
        return check_password_hash(self.password_hash, password) # return Tre/False
